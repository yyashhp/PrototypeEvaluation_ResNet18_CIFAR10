    ...
    #    stacked_sets_latent_boundaries = []
      ...
      #  for proto in par_image_tensors:
        ...
        for t in range(1):
            ...
            torch.save(torch.stack(set_latent_boundaries, dim = 0), f"{saved_boundaries_path}/Final3_Boundaries_Latents_{date_time}.pt")
            torch.save(torch.stack(set_trained_boundaries, dim=0), f"{saved_boundaries_path}/Final3_Boundaries_Images_{date_time}.pt")
