...
def main():
    ...
    #
       ...
       # combined_boundary_latent = torch.mean(torch.stack(stacked_sets_latent_boundaries, dim=0), dim=0)
        ...
        batch_cum_trained_col_cs, batch_cum_trained_col_cs_std = torch.std_mean(batch_trained_col_cs, dim=4)
        ...
        final_comb_trained_cols_cs_diffs.append(cum_trained_col_cs)
        final_comb_trained_cs_std.append(torch.mean(batch_cum_trained_cs_std))
        final_comb_trained_col_cs_std.append(torch.mean(batch_cum_trained_col_cs_std))
        final_ind_trained_col_cs_diffs.append([1 - val for val in batch_cum_trained_col_cs])
        final_ind_trained_cs_col_stds.append(batch_cum_trained_col_cs_std)
        final_ind_trained_cs_diffs.append([1 - val for val in batch_cum_trained_cs])
        final_ind_trained_cs_diffs_std.append(batch_cum_trained_cs_std)
